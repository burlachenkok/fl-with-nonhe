...
def get_sampled_clients(num_clients, args, exec_ctx):
    ...
    if args.client_sampling_type == "uniform":
        ...
        #=============================================================================
        if 'fixed_client' in exec_ctx.experimental_options:
            fixed_client = int(exec_ctx.experimental_options['fixed_client'])
            for i in range(args.rounds):
                assert len(sampled_clients[i]) == 1
                sampled_clients[i][0] = fixed_client
        #=============================================================================
