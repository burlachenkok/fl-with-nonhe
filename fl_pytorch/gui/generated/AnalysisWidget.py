...
class Ui_AnalysisWidget(object):
    ...
    def retranslateUi(self, AnalysisWidget):
        ...
        self.cbxXaxis.setItemText(16, _translate("AnalysisWidget", "# of bits from master"))
        self.cbxXaxis.setItemText(17, _translate("AnalysisWidget", "Full gradient oracles (train)"))
        self.cbxXaxis.setItemText(18, _translate("AnalysisWidget", "Sample gradient oracles (train)"))
        self.cbxXaxis.setItemText(19, _translate("AnalysisWidget", "Loss (validation)"))
        self.cbxXaxis.setItemText(20, _translate("AnalysisWidget", "Top1 acc (validation)"))
        self.cbxXaxis.setItemText(21, _translate("AnalysisWidget", "Top5 acc (validation)"))
        self.cbxXaxis.setItemText(22, _translate("AnalysisWidget", "Number of compute devices"))
        ...
        self.cbxYaxis.setItemText(16, _translate("AnalysisWidget", "# of bits from master"))
        self.cbxYaxis.setItemText(17, _translate("AnalysisWidget", "Full gradient oracles (train)"))
        self.cbxYaxis.setItemText(18, _translate("AnalysisWidget", "Sample gradient oracles (train)"))
        self.cbxYaxis.setItemText(19, _translate("AnalysisWidget", "Loss (validation)"))
        self.cbxYaxis.setItemText(20, _translate("AnalysisWidget", "Top1 acc (validation)"))
        self.cbxYaxis.setItemText(21, _translate("AnalysisWidget", "Top5 acc (validation)"))
        self.cbxYaxis.setItemText(22, _translate("AnalysisWidget", "Number of compute devices"))
