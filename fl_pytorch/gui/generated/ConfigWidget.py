...
class Ui_ConfigWidget(object):
    def setupUi(self, ConfigWidget):
        ...
        self.tabExeprimentConfig.setGeometry(QtCore.QRect(0, 0, 1031, 1034))
        ...
        self.formLayout.setWidget(31, QtWidgets.QFormLayout.LabelRole, self.lblMu)
        self.edtMu = QtWidgets.QLineEdit(self.frameExperimentConfig)
        self.edtMu.setObjectName("edtMu")
        self.formLayout.setWidget(31, QtWidgets.QFormLayout.FieldRole, self.edtMu)
        self.lblL = QtWidgets.QLabel(self.frameExperimentConfig)
        self.lblL.setObjectName("lblL")
        self.formLayout.setWidget(33, QtWidgets.QFormLayout.LabelRole, self.lblL)
        self.edtL = QtWidgets.QLineEdit(self.frameExperimentConfig)
        self.edtL.setObjectName("edtL")
        self.formLayout.setWidget(33, QtWidgets.QFormLayout.FieldRole, self.edtL)
        ...
        self.formLayout.setWidget(34, QtWidgets.QFormLayout.LabelRole, self.lblSamplesPerClient)
        ...
        self.formLayout.setWidget(36, QtWidgets.QFormLayout.FieldRole, self.cbxHomogeneousDS)
        ...
        self.formLayout.setWidget(39, QtWidgets.QFormLayout.LabelRole, self.lblGlobalModel)
        ...
        self.cbxGlobalModel.addItem("")
        self.cbxGlobalModel.addItem("")
        self.formLayout.setWidget(39, QtWidgets.QFormLayout.FieldRole, self.cbxGlobalModel)
        ...
        self.formLayout.setWidget(40, QtWidgets.QFormLayout.LabelRole, self.lblLossFunctionForGlobalModel)
        ...
        self.cbxLossFunctionForGlobalModel.addItem("")
        self.cbxLossFunctionForGlobalModel.addItem("")
        self.formLayout.setWidget(40, QtWidgets.QFormLayout.FieldRole, self.cbxLossFunctionForGlobalModel)
        ...
        self.formLayout.setWidget(42, QtWidgets.QFormLayout.LabelRole, self.lblExtraRegulizer)
        ...
        self.formLayout.setLayout(42, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_5)
        ...
        self.formLayout.setWidget(45, QtWidgets.QFormLayout.LabelRole, self.lblValidationOptMetric)
        ...
        self.cbxValidationOptMetric.addItem("")
        self.cbxValidationOptMetric.addItem("")
        self.formLayout.setWidget(45, QtWidgets.QFormLayout.FieldRole, self.cbxValidationOptMetric)
        ...
        self.formLayout.setWidget(46, QtWidgets.QFormLayout.LabelRole, self.lblValidationAssementFreq)
        ...
        self.formLayout.setWidget(46, QtWidgets.QFormLayout.FieldRole, self.edtValidationAssementFreq)
        ...
        self.formLayout.setWidget(47, QtWidgets.QFormLayout.LabelRole, self.lblTrackQuantities)
        ...
        self.formLayout.setWidget(47, QtWidgets.QFormLayout.FieldRole, self.widget_2)
        self.label_5 = QtWidgets.QLabel(self.frameExperimentConfig)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(29, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.cbxWeightsCentralizedConsistency = QtWidgets.QCheckBox(self.frameExperimentConfig)
        self.cbxWeightsCentralizedConsistency.setText("")
        self.cbxWeightsCentralizedConsistency.setObjectName("cbxWeightsCentralizedConsistency")
        self.formLayout.setWidget(29, QtWidgets.QFormLayout.FieldRole, self.cbxWeightsCentralizedConsistency)
        ...
        self.cbxDataset.setCurrentIndex(9)
    ...
    def retranslateUi(self, ConfigWidget):
        ...
        self.cbxClientCompressor.setItemText(2, _translate("ConfigWidget", "Perm-K"))
        self.cbxClientCompressor.setItemText(3, _translate("ConfigWidget", "Bernulli"))
        self.cbxClientCompressor.setItemText(4, _translate("ConfigWidget", "Natural"))
        self.cbxClientCompressor.setItemText(5, _translate("ConfigWidget", "QSGD"))
        self.cbxClientCompressor.setItemText(6, _translate("ConfigWidget", "Natural Dithering"))
        self.cbxClientCompressor.setItemText(7, _translate("ConfigWidget", "Standart dithering"))
        self.cbxClientCompressor.setItemText(8, _translate("ConfigWidget", "Top-K (biased)"))
        self.cbxClientCompressor.setItemText(9, _translate("ConfigWidget", "Rank-K (biased)"))
        self.cbxClientCompressor.setItemText(10, _translate("ConfigWidget", "TernGrad"))
        ...
        self.edtExperimentalExtraOpts.setText(_translate("ConfigWidget", "he:1"))
        ...
        self.cbxDataset.setItemText(30, _translate("ConfigWidget", "Librispeech"))
        self.cbxDataset.setItemText(31, _translate("ConfigWidget", "Librilight"))
        ...
        self.cbxGlobalModel.setItemText(16, _translate("ConfigWidget", "wav2vec2_base"))
        self.cbxGlobalModel.setItemText(17, _translate("ConfigWidget", "wav2vec_large"))
        ...
        self.cbxLossFunctionForGlobalModel.setItemText(3, _translate("ConfigWidget", "CTC"))
        ...
        self.label_5.setText(_translate("ConfigWidget", "Weights consistency with centralized opt."))
